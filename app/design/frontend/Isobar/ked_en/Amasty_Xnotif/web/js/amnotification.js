...
define([
    ...
    $.widget('mage.amnotification', {
        ...
        _getSelectedKey: function () {
            var selectedKey = [];
            this.settingsForKey
                = this.parent.find('.product-info-main select.super-attribute-select, .product-info-main div.swatch-option.selected:not(.slick-cloned), .product-info-main select.swatch-select');
