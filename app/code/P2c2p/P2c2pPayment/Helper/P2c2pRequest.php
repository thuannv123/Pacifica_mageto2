...
class P2c2pRequest extends AbstractHelper{
	...
	function __construct(ScopeConfigInterface $configSettings, P2c2pHash $p2c2pHash, 
		...
		$this->objConfigSettings = $configSettings->getValue('payment/p2c2ppayment', \Magento\Store\Model\ScopeInterface::SCOPE_WEBSITE);
		$this->objStoreName = $configSettings->getValue('general/store_information/name', \Magento\Store\Model\ScopeInterface::SCOPE_STORE);
	...
	private function generateP2c2pCommonFormFields($parameter) {
		...
		$this->arrayP2c2pFormFields["version"] 				= "8.5";
		...
		$this->arrayP2c2pFormFields["user_defined_1"] 		= $parameter['order_id'];
		$this->arrayP2c2pFormFields["user_defined_2"] 		= $this->objStoreName . " - " . $this->objStoreManagerInterface->getStore()->getBaseUrl();
		$this->arrayP2c2pFormFields["user_defined_3"] 		= "2C2P@Magento V7.1.2";
		...
		$this->arrayP2c2pFormFields["promotion"]    		= isset( $this->objConfigSettings['promoCode'] ) ? $this->objConfigSettings['promoCode'] : "";
    }
    ...
    function getMerchantSelectedCurrencyCode() {
    	...
    	$currency_code = $this->objStoreManagerInterface->getStore()->getBaseCurrency()->getCode();
