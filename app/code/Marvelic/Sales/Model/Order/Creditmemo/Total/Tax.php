 ...
 */
namespace Marvelic\Sales\Model\Order\Creditmemo\Total;
    ...
    public function collect(Creditmemo $creditmemo)
    {
        ...
        if ($invoice = $creditmemo->getInvoice()) {
            ...
            if ($shippingDelta > $creditmemo->getBaseShippingAmount() ||
                ...
                $part = ($creditmemo->getShippingAmount() == 0 || $orderShippingAmount == 0) ? 0 : ($creditmemo->getShippingAmount() / $orderShippingAmount);
                $basePart = ($creditmemo->getBaseShippingAmount() == 0 || $baseOrderShippingAmount == 0) ? 0 : ($creditmemo->getBaseShippingAmount() / $baseOrderShippingAmount);
