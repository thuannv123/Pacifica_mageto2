...
namespace Marvelic\Sales\Model;
...
class AccountManagementExtend implements \Amasty\CheckoutCore\Api\AccountManagementInterface
{
    /**
    ...
    public function createAccount($order)
    {
        ...
        if (($this->config->getAdditionalOptions('create_account') === CustomerRegistration::OPTIONAL
            ...
            {
                try{
                    $this->logger->info('Create account when checkout');
                    ...
                    $this->logger->info('Done create account when checkout with ID: ' . $account->getId());
                    return $account;
                } catch (\Exception $exception) {
                $this->logger->critical($exception->getMessage());
                }    
            }else{
                $this->logger->info('Condition to create account when checkout not meet');
            }
        }
