...
class AfterPlaceBarcodeOrder extends \GBPrimePay\Payments\Controller\Checkout\AfterPlaceBarcodeOrder
{
    ...
    public function execute()
    {
        try {
            ...
            if ($this->_config->getCanDebug()) {
                $this->gbprimepayLogger->debug("Bill Payment Callback Handler //" . print_r($payload, true));
            }
            ...
            if ($this->_config->getCanDebug()) {
                $this->gbprimepayLogger->debug("AfterPlaceBarcodeOrder error//" . $exception->getMessage());
            }
            $this->cancelOrder();
