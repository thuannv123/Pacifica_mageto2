...
namespace Marvelic\AmastyXnotif\Plugins\ConfigurableProduct\Block\Product\View\Type;
...
class Configurable
{
    ...
    public function afterFetchView($subject, $html)
    {
        ...
        if (in_array($subject->getNameInLayout(), $configurableLayout)
            ...
            && $this->config->getModuleConfig('general/enabled_module')
        ) {
    ...
    public function isProductAllowed(
        Product $product,
