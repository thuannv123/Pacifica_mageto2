...
namespace Marvelic\OrderReminder\Controller\Restore;
...
class Index extends \Isobar\OrderReminder\Controller\Restore\Index
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            if (!$order->getCustomerIsGuest()) {
                ...
                if ($quote->getShippingAddress() == null || !$quote->getShippingAddress()->getCountryId()) {
