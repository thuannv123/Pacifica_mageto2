...
namespace Marvelic\VisualMerchandiser\Block\Adminhtml\Category\Merchandiser;
...
class Tile extends \Magento\Backend\Block\Widget\Grid
{
     ...
     * @since 100.1.0
     */
    protected $_template = 'Magento_VisualMerchandiser::category/merchandiser/tile.phtml';
        ...
        foreach ($attributeCodes as $code) {
            ...
            if($code == 'stock'){
                if($product->getTypeId() == 'simple'){
                    ...
                    $productStockItem = $this->_stockItemRepository->getStockItem($productId);
                    $stockQuantities = $productStockItem->getQty();
