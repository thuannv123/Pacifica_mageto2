<?php
namespace Isobar\Megamenu\Controller\Adminhtml\Category;
...
class Block extends \Magento\Catalog\Controller\Adminhtml\Category
{
    ...
    /**
     * @return \Magento\Framework\App\ResponseInterface|\Magento\Framework\Controller\Result\Json|\Magento\Framework\Controller\Result\Raw|\Magento\Framework\Controller\Result\Redirect|\Magento\Framework\Controller\ResultInterface|null
     */
        ...
        switch ($this->getRequest()->getParam('entity')) {
            ...
            case 'products':
                ...
                $block = $this->layoutFactory->create()->createBlock(
                    'Isobar\Megamenu\Block\Adminhtml\Category\Tab\Products',
                    ''
                );
