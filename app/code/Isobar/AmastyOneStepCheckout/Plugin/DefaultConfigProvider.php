...
namespace Isobar\AmastyOneStepCheckout\Plugin;
...
class DefaultConfigProvider
{
    ...
    public function afterGetConfig(\Magento\Checkout\Model\DefaultConfigProvider $subject, $config)
    {
        ...
        if (!isset($config['shippingAddressFromData'])) {
            ...
            if ($quote->getCustomerId() && $shippingAddress->getCustomerAddressId()) {
        ...
        if (!isset($config['validatedEmailValue']) && $quote->getCustomerEmail()) {
            $config['validatedEmailValue'] = $quote->getCustomerEmail();
        }
