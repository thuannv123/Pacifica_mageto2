<?php
namespace Isobar\SocialLogin\Model\LoginBlock\Template;

use Isobar\SocialLogin\Exception\InvalidTemplateException;
use Isobar\SocialLogin\Model\LoginBlock\Template;
