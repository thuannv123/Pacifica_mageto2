<?php
namespace Isobar\SocialLogin\Model\Provider\Factory;

use Isobar\SocialLogin\Model\Config\ProviderInterface as ProviderConfig;
use Isobar\SocialLogin\Model\Provider\ServiceBuilderInterface;

/**
 * Base provider factory
 */
class Base extends \Isobar\SocialLogin\Model\Provider\AbstractFactory
{
    /**
