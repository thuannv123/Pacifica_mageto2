...
// echo "<br>getUseothercard-".$this->_config->getUseothercard();
...
$gbdevdebug = $this->_config->GBdevDebug();
 ...
 if($gbdevdebug == "true"){
  echo '<br>GBdevDebug<br>true<br>';
  echo '<br>checkoutSession<br>getData<pre>';
  print_r($this->checkoutSession->getData());
  echo '</pre>';
  $_last_order_id = $this->checkoutSession->getLastOrderId();
    
  echo '<br>execute<br>_last_order_id<pre>';print_r($_last_order_id);echo '</pre>';
  
  
  
  $_orderId = $this->checkoutSession->getLastRealOrder()->getId();
  
  echo '<br>execute<br>_orderId<pre>';print_r($_orderId);echo '</pre>';
  $_orderIncrementId = $this->checkoutSession->getLastRealOrder()->getIncrementId();
  
  echo '<br>execute<br>_orderIncrementId<pre>';print_r($_orderIncrementId);echo '</pre>';
  
  
  
  
  echo "<br>moduleCSPCheck-".$this->moduleCSPCheck();
  echo '<br>';
  echo '<br>';
 }else{
  exit;
...
echo $domain;
echo "<br>new-domain-<br>".$domain;
var_dump($domain);
echo "<br>";
echo "<br>";


$_arrayofdomain = $this->_config->getArrayOfDomain();
echo '<br>db_arrayofdomain<br><pre>';print_r($_arrayofdomain);echo '</pre>';



echo "<br>getDomain-<br>".$this->_config->getDomain();
echo "<br>";
$check_domain = $this->_config->getDomain();
if (array_search($check_domain, $_arrayofdomain) !== false) {
  echo "pass inarray";
}else{
  echo "noin pass";
}
...
echo "<br>";
echo "<br>";
var_dump(array_search($check_domain, $_arrayofdomain));
echo "<br>";
echo "<br>";
// exit;
...
exit;
      ...
      if ($this->_config->getCanDebug()) {
          $this->gbprimepayLogger->debug("getMerchantId //" . print_r($callback, true));
      }
      echo '<pre>';
      print_r($callback);
      ...
      if ($this->_config->getCanDebug()) {
          $this->gbprimepayLogger->debug("URL_CHECKPUBLICKEY_TEST //" . print_r($callback, true));
      }
      // echo '<pre>';
      print_r($callback);
...
if (!empty($callback['merchantId']) && !empty($callback['initialShop']) && !empty($callback['merchantName'])) {
  ...
  echo '2-merchantId-initialShop-merchantName:<br>false';
      ...
      if ($this->_config->getCanDebug()) {
          $this->gbprimepayLogger->debug("URL_CHECKPRIVATEKEY_TEST //" . print_r($callback, true));
      }
      echo '<br>';
      print_r($callback);
      echo '<br>';
      ...
      if ($this->_config->getCanDebug()) {
          $this->gbprimepayLogger->debug("URL_CHECKCUSTOMERKEY_TEST //" . print_r($callback, true));
      }
      ...
      if ($this->_config->getCanDebug()) {
          $this->gbprimepayLogger->debug("URL_API_TEST //" . print_r($callback, true));
      }
      echo '<br>sendAPICurl';
      print_r($callback);
      echo '<br>';
