...
abstract class Checkout extends \Magento\Framework\App\Action\Action
{
    ...
    public function moduleCSPCheck()
    {
        try {
    ...
    public function failureOrder($orderId, $status, $order_note)
    {
        ...
        $this->checkoutSession->setLastOrderStatus(\Magento\Sales\Model\Order::STATE_CANCELED);
        $this->_eventManager->dispatch('gbprimepay_sales_order_payment_cancel');
    ...
    public function getOrderCompleteStatus($orderId)
    {
        ...
        if(($ResponseState == "complete") && ($ResponseStatus == "complete") || ($ResponseState == "processing") && ($ResponseStatus == "processing")){
