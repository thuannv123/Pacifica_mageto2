    ...
    public function execute()
    {
        try {
            ...
            if ($this->_config->getCanDebug()) {
                $this->gbprimepayLogger->debug("data-callback //" . print_r($check, true));
            }
...
//                    ]);
            ...
            if ($this->_config->getCanDebug()) {
                $this->gbprimepayLogger->debug($exception->getMessage());
            }
        }
    }
    ...
    public function checkEnable()
    {
      if ($this->_config->getActiveCreditCard()) {
        ...
        if ($this->_config->getCanDebug()) {
            $this->gbprimepayLogger->debug("sendPublicCurl-callback //" . print_r($callback, true));
        }
