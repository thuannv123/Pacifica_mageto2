    ...
    $customer_id = $order->getQuote()->getCustomerId();
        ...
        try{
            if ($this->_config->getCanDebug()) {
                $this->gbprimepayLogger->debug("RequestBeforeQrcode array data_item" .print_r($_item,true));
            }
        }catch(\Exception $exception){
            if ($this->_config->getCanDebug()) {
                $this->gbprimepayLogger->debug("RequestBeforeQrcode error array data_item //" . $exception->getMessage());
            }
        }
