...
require(
    ...
    'use strict';
        ...
        ToSelect.prototype = {
            ...
            var label_payments = window.gbprimepay.installment_js_payments;
            var label_total = window.gbprimepay.installment_js_total;
...
infotxt += '</tr>';
infotxt += '<tr cellpadding="0" cellspacing="0" height="100%" width="100%" style="border: none !important;padding: 0;">';
infotxt += '<td cellpadding="0" cellspacing="0" height="50%" width="100%" style="border: none !important;width:25%;min-width170px;text-align: left; vertical-align: top;padding: 0 0 5px 0;"><span style="border: none !important;margin:0;padding:0 0 0 5px;line-height: 1 !important;">'+ label_payments +'</span></td>';
infotxt += '</tr>';
infotxt += '<tr cellpadding="0" cellspacing="0" height="100%" width="100%" style="border: none !important;padding: 0;">';
infotxt += '<td colspan="3" cellpadding="0" cellspacing="0" height="100%" width="100%" style="border: none !important;text-align: center; vertical-align: middle;margin:0;padding: 10px 0 0 0;"><span style="border: none !important;margin:0;padding:0 15px 0 0;line-height: 1 !important;">'+ label_total +' </span><span style="border: none !important;margin:0;padding:0;line-height: 1 !important;"><strong>'+currency_format(varAamountFix)+'</strong></span></td>';
infotxt += '</tr>';
infotxt += '</tbody>';
infotxt += '</table>';
infotxt += '</td>';
