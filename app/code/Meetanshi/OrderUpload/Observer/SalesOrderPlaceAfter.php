...
class SalesOrderPlaceAfter implements ObserverInterface
{
     ...
     */
    public function __construct(RequestInterface $request, HelperData $helper, Data $jsonHelper, OrderUploadFactory $orderUploadFactory, EmailData $emailData, TimezoneInterface $timezone)
    {
        $this->helper = $helper;
